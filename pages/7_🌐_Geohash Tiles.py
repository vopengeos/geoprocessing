...
with form:   
    ...
    if  url or uploaded_file:
        ...
        with col1:   
            ...
            m = folium.Map(tiles='openstreetmap', location = [center_lat, center_lon], zoom_start=4, max_zoom = 20)           
        ...
        if submitted:
            ...
            target = compute_geohash_tiles_from_polygon(gdf,interpolation_distance=0.00001)
            with col2:
                if not target.empty: 
